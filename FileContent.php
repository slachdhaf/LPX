...
foreach ($cursor as $pat) {
    ...
    $logLine .= '</td>';
    $logLine .= '<td>' . $result[strval($pat['_id'])] . ',' . $pat['count'] . '</td>';
...
echo '<img src="img/check_list.png" class="title_icon"/><h1>Contenu du fichier</h1> - <span class="result-count">' . count($log_file['logs']) . '</span> logs<h1 class="prev"><<</h1>';
echo '<hr/>';
